...
async def test_a(dut):
    ...
    await Timer(100, 'ns')
    for i in range(4):
        note = [0,random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1),random.randint(0,1)]
        ...
        vel = [0,0,0,0,0,0,0,0]
        input_on = [[1,0,0,1,0,0,0,0], note, vel]
        input_off = [[1,0,0,0,0,0,0,0], note, vel]
        for byte in input_on:
            ...
            dut.midi_in.value = 1
            await Timer(32000, 'ns')
        dut.note_plays.value = 2**(60+9*(i%2))
        for _ in range(300):
            await Timer(10, 'ns')
